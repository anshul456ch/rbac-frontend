<template>
  <div class="p-6">
    ...
    <Button :disabled="loading" color="primary" type="submit" @click="showModal = true">
      ...
      >
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-3">
              <Button color="danger" @click="deleteProject(p.id)"
                >Delete</Button
              >
            </td>
          </tr>
          <tr v-if="projects.length === 0">
            <td colspan="4" class="p-3 text-center text-gray-500">
              No projects found. Click <strong>Add Project</strong> to create
              one.
            </td>
          </tr>
        </tbody>
